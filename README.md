...
-	Xóa một hàng trong bảng danh sách thông tin nhân viên
-	Hủy chức năng
-	Cập nhật lại các thông tin nhân viên mà mình muốn sửa lại.
-	Khởi tạo một thông tin nhân viên mới
-	Lưu thông tin vào danh sách nhân viên - Thanh tìm kiếm thông tin nhân viên.
...
-	Xóa một hàng trong bảng danh sách thông tin khách hàng
-	Hủy chức năng
-	Cập nhật lại các thông tin khách hàng mà mình muốn sửa lại.
-	Khởi tạo một thông tin mới
-	Lưu thông tin vào danh sách khách hàng
-	Thanh tìm kiếm và nút tra cứu thông tin khách hàng.
...
-	Xóa một hàng trong bảng danh sách thông tin hóa đơn
-	Hủy chức năng
-	Cập nhật lại các thông tin hóa đơn mà mình muốn sửa lại.
-	Khởi tạo một thông tin hóa đơn mới
-	Lưu thông tin vào danh sách hóa đơn
-	Thanh tìm kiếm và nút tra cứu thông tin hóa đơn.
-	Nhấn nút xem CTHD để hiển thị giao diện form quản lý CTHD.
...
➢	Quản lý chức năng thông tin khách hàng:
-	Thêm thông tin sản phẩm vào bảng chi tiết hóa đơn.
-	Xóa một hàng trong bảng danh sách thông tin chi tiết hóa đơn
-	Hủy chức năng.
-	Cập nhật lại các thông tin chi tiết hóa đơn mà mình muốn sửa lại. - Khởi tạo một thông tin chi tiết hóa đơn mới.
-	Lưu thông tin mã hóa đơn, sản phẩm, số lượng, đơn giá, thành tiền vào danh sách chi tiết hóa đơn.
